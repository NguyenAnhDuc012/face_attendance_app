...
class IntakeCreate extends StatefulWidget {
  const IntakeCreate({Key? key}) : super(key: key);

  @override
  State<IntakeCreate> createState() => _IntakeCreateState();
}

class _IntakeCreateState extends State<IntakeCreate> {
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: Column(
              children: [
                const TopBar(title: 'Khóa học', subtitle: 'Thêm mới'),
                Expanded(
